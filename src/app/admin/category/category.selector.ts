...
// selector to get a selected category
export const selectedCategoryItem = (categoryId: number) =>
  createSelector(selectCategoryState, (state: CategoryState) => {
    const category: Category | undefined = state.categories.find((category) => {
